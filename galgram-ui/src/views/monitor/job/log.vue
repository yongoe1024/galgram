  ...
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="任务组名"
        ...
        <el-select v-model="queryParams.jobGroup"
                   ...
                   clearable
                   style="width: 240px">
          <el-option v-for="dict in dict.type.sys_job_group"
                     :key="dict.value"
                     :label="dict.label"
                     :value="dict.value" />
        </el-select>
      ...
      <el-form-item label="执行状态"
        ...
        <el-select v-model="queryParams.status"
                   ...
                   clearable
                   style="width: 240px">
          <el-option v-for="dict in dict.type.sys_common_status"
                     :key="dict.value"
                     :label="dict.label"
                     :value="dict.value" />
        </el-select>
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="执行状态"
                       ...
                       prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_common_status"
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="异常信息："
                          v-if="form.status == 1">{{ form.exceptionInfo }}</el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div slot="footer"
