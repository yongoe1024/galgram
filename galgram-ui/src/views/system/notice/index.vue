    ...
    <el-form :model="queryParams"
      ...
      <el-form-item label="类型"
        ...
        <el-select v-model="queryParams.noticeType"
                   placeholder="公告类型"
                   clearable>
          <el-option v-for="dict in dict.type.sys_notice_type"
                     :key="dict.value"
                     :label="dict.label"
                     :value="dict.value" />
        </el-select>
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="公告类型"
        ...
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_notice_type"
      ...
      <el-table-column label="状态"
                       ...
                       width="100">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_notice_status"
          ...
          <el-col :span="24">
            <el-form-item label="状态">
              <el-radio-group v-model="form.status">
                <el-radio v-for="dict in dict.type.sys_notice_status"
                          :key="dict.value"
